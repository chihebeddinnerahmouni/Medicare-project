import { CiMedicalClipboard } from "react-icons/ci"; // import { useTranslation } from "react-i18next";
...
const OffersCont = ({ offers }: any) => {
  ...
  return (
    <section>
      ...
      <div className="offers grid grid-cols-1 mt-3 gap-2 lg:mt-5 md:grid-cols-2">
        {offers.map((offer: any, index: number) => (
          <div key={index} className="offer flex items-center gap-2">
            <CiMedicalClipboard className="pin text-[22px] text-writingMainDark lg:text-[26px]" />
